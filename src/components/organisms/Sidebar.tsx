...
export function Sidebar({
  ...
  return (
    <nav
      ...
      className="flex h-full flex-col bg-zinc-900 px-2 py-4"
    >
      ...
      <div className="px-1 pb-2">
        <button
          ...
          className="w-full rounded-md px-3 py-2 text-left text-xs font-medium text-slate-500 transition-colors duration-150 hover:bg-white/5 hover:text-slate-300"
        >
          Exportar Excel
        </button>
      </div>
      ...
      <div className="border-t border-white/10 px-1 pt-3">
        <div
          ...
          className="flex items-center gap-2 rounded-md px-3 py-2 text-xs text-slate-400"
        >
