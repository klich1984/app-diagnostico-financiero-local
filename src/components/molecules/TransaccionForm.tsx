...
export function TransaccionForm({
  ...
  return (
    <form
      ...
      className="mx-auto max-w-lg space-y-4 rounded-lg border border-white/10 bg-zinc-900 p-6 shadow-sm"
      noValidate
    >
      ...
      <div className="space-y-1">
        <label htmlFor="tipo_flujo" className="block text-sm font-medium text-slate-300">
          Tipo
        </label>
        <select
          id="tipo_flujo"
          ...
          className="w-full rounded-md border border-white/10 bg-zinc-800 px-3 py-2 text-sm text-slate-100 focus:border-white/30 focus:outline-none"
        >
      ...
      {/* Concepto */}
      <div className="space-y-1">
        <label htmlFor="concepto" className="block text-sm font-medium text-slate-300">
          Concepto
        </label>
        <input
          id="concepto"
        ...
        />
        {errors.concepto ? (
          <p id="concepto-error" role="alert" className="text-sm text-red-400">
            {errors.concepto}
          </p>
        ) : null}
      </div>
      ...
      {/* Frecuencia */}
      <div className="space-y-1">
        <label htmlFor="frecuencia" className="block text-sm font-medium text-slate-300">
          Frecuencia
        </label>
        <select
          id="frecuencia"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          <label htmlFor="comportamiento" className="block text-sm font-medium text-slate-300">
            Comportamiento
          </label>
          <select
            id="comportamiento"
      ...
      <div className="space-y-1">
        <label htmlFor="valor" className="block text-sm font-medium text-slate-300">
          Valor (en pesos)
        </label>
        <p className="text-xs text-slate-500">
          Usá punto como separador de miles y coma para decimales.{' '}
          <span className="font-medium text-slate-400">Ej: 1.500.000 o 1.500.000,50</span>
        </p>
        <input
          id="valor"
          name="valor"
        ...
        />
        {errors.valor ? (
          <p id="valor-error" role="alert" className="text-sm text-red-400">
            {errors.valor}
          </p>
        ) : null}
      </div>
      ...
      <button
        type="submit"
        className="w-full rounded-md bg-[#f05454] px-4 py-2 text-sm font-medium text-white hover:bg-[#d94444] focus:outline-none focus:ring-2 focus:ring-[#f05454] focus:ring-offset-2 focus:ring-offset-zinc-900"
      >
      ...
      {initialValue && onCancelar ? (
        <button
          ...
          onClick={onCancelar}
          className="w-full rounded-md border border-white/10 px-4 py-2 text-sm font-medium text-slate-300 hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2 focus:ring-offset-zinc-900"
        >
          Cancelar
        </button>
      ) : null}
